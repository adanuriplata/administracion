              ...
              <form method="POST" action="<?= base_url().'/customers/update' ?>">
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="CustomerCompany" name="CustomerCompany" placeholder="Ingresa el nombre de la empresa" value="<?= $user['company'] ?>">
                    </div>
                    <div class="form-group">
                        <label for="Owner">Propietario</label>
                        <input type="text" class="form-control" id="CustomerOwner" name="CustomerOwner" placeholder="Ingresa el nombre del propietario" value="<?= $user['owner'] ?>">
                    </div>    
                    <div class="form-group">
                        <label for="clienteCorreo">Correo</label>
                        <input type="email" class="form-control" id="CustomerEmail" name="CustomerEmail" placeholder="Ingresa el Correo" value="<?= $user['email'] ?>">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">Teléfono</label>
                        <input type="phone" class="form-control" id="CustomerPhone" name="CustomerPhone" placeholder="Ingresa el Teléfono" value="<?= $user['phone'] ?>">
                    </div>
                    <div class="form-group">
                        <input type="hidden" class="form-control" id="CustomerId" name="CustomerId" value="<?= $user['id_customer'] ?>">
                    </div>
