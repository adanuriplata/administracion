              ...
              <form method="POST" action="<?= base_url().'/customers/save' ?>">
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="CustomerCompany" name="CustomerCompany" placeholder="Ingresa el nombre de la empresa">
                    </div>
                    <div class="form-group">
                        <label for="Owner">Propietario</label>
                        <input type="text" class="form-control" id="CustomerOwner" name="CustomerOwner" placeholder="Ingresa el nombre del propietario">
                    </div>    
                    <div class="form-group">
                        <label for="clienteCorreo">Correo</label>
                        <input type="email" class="form-control" id="CustomerEmail" name="CustomerEmail" placeholder="Ingresa el Correo">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">Teléfono</label>
                        <input type="phone" class="form-control" id="CustomerPhone" name="CustomerPhone" placeholder="Ingresa el Teléfono">
                    </div>
